# User Registration Form - Blackdeep Technologies Front-End Task

This project is a solution to the front-end developer task set by Blackdeep Technologies. It involves creating a multi-step user registration form designed to assess understanding of fundamental front-end development principles, including React, TypeScript, form handling, validation, and component-based architecture.
...
* **Task Focus:** This project was developed to meet the specific requirements of the Blackdeep Technologies front-end developer task.
...
* **Deployment (Bonus):** The project has been deployed using Vercel and is accessible online at: https://blackdeep-technologies.vercel.app/
